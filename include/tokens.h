...
//	16		17	  18		19	  20		21
	ttFunction, ttCallFunc, ttStatement, ttCompound, ttDeclare, ttProgram, ttTagged
};
...
// 68	69	70	71	72	73	74	75	76	77	78	79
  tkTag, tkIF, tkELSIF, tkELSE, tkALLOF, tkANYOF, tkEXISTS, tkFALSE, tkTRUE, tkNOT, tkSIZE, tkHEADER,
// 80		81	82	83	84		85	86	87
  tkADDRESS, tkCURDATE, tkSTOP, tkSET, tkFILEINTO, tkKEEP, tkREDIRECT, tkDISCARD, tkREQUIRE
};
...
// tagged argument
class TokenTag: public TokenIdent
{
public:
    TokenTag() {}
    TokenTag(const char *k) : TokenIdent(k) {}
    TokenTag(std::string k) : TokenIdent(k) {}
    virtual int val() const  { return atol(str.c_str()); }
    virtual TokenType type() const { return TokenType::ttTagged; }
    virtual TokenID   id()   const { return TokenID::tkTag; }
    virtual TokenBase *clone()     { return new TokenStr(str); }
};
...
class TokenALLOF:    public TokenKeyword { public: TokenALLOF()    : TokenKeyword("allof"){}     virtual TokenID id() const { return TokenID::tkALLOF;    } virtual TokenBase *clone() { return (TokenBase*)new TokenALLOF();   } };
class TokenANYOF:    public TokenKeyword { public: TokenANYOF()    : TokenKeyword("anyof"){}     virtual TokenID id() const { return TokenID::tkANYOF;    } virtual TokenBase *clone() { return (TokenBase*)new TokenANYOF();   } };
class TokenEXISTS:   public TokenKeyword { public: TokenEXISTS()   : TokenKeyword("exists"){}    virtual TokenID id() const { return TokenID::tkEXISTS;   } virtual TokenBase *clone() { return (TokenBase*)new TokenEXISTS();  } };
class TokenFALSE:    public TokenKeyword { public: TokenFALSE()    : TokenKeyword("false"){}     virtual TokenID id() const { return TokenID::tkFALSE;    } virtual TokenBase *clone() { return (TokenBase*)new TokenFALSE();   } };
class TokenTRUE:     public TokenKeyword { public: TokenTRUE()     : TokenKeyword("true"){}      virtual TokenID id() const { return TokenID::tkTRUE;     } virtual TokenBase *clone() { return (TokenBase*)new TokenTRUE();    } };
class TokenNOT:      public TokenKeyword { public: TokenNOT()      : TokenKeyword("not"){}       virtual TokenID id() const { return TokenID::tkNOT;      } virtual TokenBase *clone() { return (TokenBase*)new TokenNOT();     } };
class TokenSIZE:     public TokenKeyword { public: TokenSIZE()     : TokenKeyword("size"){}      virtual TokenID id() const { return TokenID::tkSIZE;     } virtual TokenBase *clone() { return (TokenBase*)new TokenSIZE();    } };
class TokenHEADER:   public TokenKeyword { public: TokenHEADER()   : TokenKeyword("header") {}   virtual TokenID id() const { return TokenID::tkHEADER;   } virtual TokenBase *clone() { return (TokenBase*)new TokenHEADER();  } };
class TokenADDRESS:  public TokenKeyword { public: TokenADDRESS()  : TokenKeyword("address") {}  virtual TokenID id() const { return TokenID::tkADDRESS;  } virtual TokenBase *clone() { return (TokenBase*)new TokenADDRESS(); } };

class TokenCURDATE:  public TokenKeyword { public: TokenCURDATE()  : TokenKeyword("currentdate") {} virtual TokenID id() const { return TokenID::tkCURDATE; } virtual TokenBase *clone() { return (TokenBase*)new TokenCURDATE(); } };
class TokenSTOP:     public TokenKeyword { public: TokenSTOP()     : TokenKeyword("stop") {}     virtual TokenID id() const { return TokenID::tkSTOP;     } virtual TokenBase *clone() { return (TokenBase*)new TokenSTOP();    } };
class TokenSET:      public TokenKeyword { public: TokenSET()      : TokenKeyword("set"){}       virtual TokenID id() const { return TokenID::tkSET;      } virtual TokenBase *clone() { return (TokenBase*)new TokenSET();     } };

class TokenFILEINTO: public TokenKeyword { public: TokenFILEINTO() : TokenKeyword("fileinto") {} virtual TokenID id() const { return TokenID::tkFILEINTO; } virtual TokenBase *clone() { return (TokenBase*)new TokenFILEINTO(); } };
class TokenKEEP:     public TokenKeyword { public: TokenKEEP()     : TokenKeyword("keep") {}     virtual TokenID id() const { return TokenID::tkKEEP;     } virtual TokenBase *clone() { return (TokenBase*)new TokenKEEP();    } };
class TokenREDIRECT: public TokenKeyword { public: TokenREDIRECT() : TokenKeyword("redirect") {} virtual TokenID id() const { return TokenID::tkREDIRECT; } virtual TokenBase *clone() { return (TokenBase*)new TokenREDIRECT(); } };
class TokenDISCARD:  public TokenKeyword { public: TokenDISCARD()  : TokenKeyword("discard") {}  virtual TokenID id() const { return TokenID::tkDISCARD;  } virtual TokenBase *clone() { return (TokenBase*)new TokenDISCARD(); } };

class TokenREQUIRE: public TokenKeyword
{
public:
    TokenBase *capabilities;
    TokenREQUIRE() : TokenKeyword("require") { capabilities = NULL; }
    virtual TokenBase *parse(Program &);
    virtual TokenID id() const { return TokenID::tkREQUIRE; }
    virtual TokenBase *clone() { return new TokenREQUIRE(); }
};
...
class TokenELSIF: public TokenKeyword
{
public:
    TokenBase *condition;
    TokenBase *statement;
    TokenBase *elsestmt;
    TokenELSIF() : TokenKeyword("elsif") { condition = statement = elsestmt = NULL; }
    virtual TokenBase *parse(Program &);
    virtual TokenID id() const { return TokenID::tkELSIF; }
    virtual TokenBase *clone() { return new TokenELSIF(); }
};
